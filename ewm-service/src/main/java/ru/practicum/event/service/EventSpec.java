...
public class EventSpec {
    public Specification<Event> specAdmin(List<Long> users, List<String> states, List<Long> categories,
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            if (states != null && !states.isEmpty()) {
                List<State> eventStates = states.stream()
                        .map(State::valueOf)
                        .toList();
    ...
    public Specification<Event> specPublic(String text, List<Long> categories, Boolean paid,
                                           LocalDateTime rangeStart, LocalDateTime rangeEnd,
